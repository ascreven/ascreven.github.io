(function(){
  ...
  .controller("projectsController", function(){
    this.projects = [
      ...
      {title: "All About Chew", url: 'all-about-chew.herokuapp.com/', imageUrl: 'styles/images/all_about_chew.png', description: 'A Ruby on Rails application that profiles local shelter animals. The app runs on a PostgreSQL database that is updated whenever a local shelter creates, edits, or destroys a profile. Using Devise, I was able to ensure that only authorized users can update the database; however, profiles are open to the public at large.' },
